...
render(){
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
        ...
        <img class="d-block w-100" src="/img/POKEMONMEWTWO.jpg" alt="First slide" width="100" height="100"/>
...
<button type="button" class="btn btn-success"><strong><a href="https://serene-bubblegum-2b2e9a.netlify.app/" target="blank">Ver Proyecto</a></strong></button>
    ...
    <img class="d-block w-100" src="/img/pokedex.jpg" alt="Second slide" width="100" height="100"/>
    ...
    <img class="d-block w-100" src="/img/pelis.jpg" alt="Third slide" width="100" height="100"/>
